...
const ComingSoon: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to from-primary-900 via-primary-800 to-secondary-900 flex items-center justify-center px-4 relative overflow-hidden">
